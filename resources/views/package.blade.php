...
<div class="container mt-4">
   ...
   <div class="col-md-12 grid-margin stretch-card mb-5">
      ...
      <div class="col-md-12 col-lg-12">
         ...
         <div id="tracking">
            <div class="text-center tracking-status-intransit" style="background-color: #1439a5">
...
<style>
    ...
    .scaled {
      animation: scaleAnimation 2s infinite; /* 4s duration, infinite loop */
      fill: #0c9100;
    }
</style>
