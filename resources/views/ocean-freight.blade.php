...
<head>
    <!-- Meta Tag -->
    <meta charset="utf-8" />
    <title>Ranbax - Ocean Freight</title>
                ...
                <div class="col-xl-2 col-lg-3 col-md-6 col-sm-6">
                    <div class="footer-widget footer1_col_2 widget_nav_menu">
                        ...
                        <div class="widget-menu">
                            <ul>
                                <li>
                                    <a href="#"> <i class="flaticon-plus"></i> Air Freight</a>
                                </li>
                                <li>
                                    <a href="#"> <i class="flaticon-plus"></i> Ocean Freight</a>
                                </li>
                                <li>
                                    <a href="#"> <i class="flaticon-plus"></i> Road Freight</a>
                                </li>
                                <li>
                                    <a href="#"> <i class="flaticon-plus"></i> Warehousing and Storage</a>
                                </li>
                            </ul>
                        </div>
                    </div>
